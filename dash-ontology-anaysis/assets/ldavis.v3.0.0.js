...
var LDAvis = function(to_select, data_or_file_name, color1, color2) {
    ...
    var margin = {
        ...
        barwidth = 340,
        barheight = 350,
        termwidth = 40, // width to add between two panels to display terms
    ...
    function visualize(data) {
        ...
        d3.select("#" + barFreqsID).append("rect")
            .attr("x", 0)
            .attr("y", mdsheight + 5 + barguide.height + 5)
            .attr("height", barguide.height)
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .attr("y", mdsheight + 5 + (3 / 2) * barguide.height + 5)
            .style("dominant-baseline", "middle")
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; width: 300px; height: 30px; float: left;marigin-left:20px");
            inputDiv.appendChild(topicDiv);

            var topicLabel = document.createElement("label");
            topicLabel.setAttribute("for", topicID);
            topicLabel.setAttribute("style", "font-family: sans-serif; font-size: 8px");
            topicLabel.innerHTML = "Selected Topic: <span id='" + topicID + "-value'></span>";
            topicDiv.appendChild(topicLabel);

            var topicInput = document.createElement("input");
            topicInput.setAttribute("style", "width: 35px");
            ...
            lambdaDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; height: 30px; width:  300px; float: left; margin-left: 140px");
            inputDiv.appendChild(lambdaDiv);

            var lambdaZero = document.createElement("div");
            lambdaZero.setAttribute("style", "padding: 5px; height: 10px; width: 220px; font-family: sans-serif; float: left");
            ...
            sliderDiv.setAttribute("style", "padding: 5px; height: 40px; width: 250px; float: left; margin-top: -8.5px; margin-right: 10px");
            ...
            lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 10px; margin-left: 40px");
        ...
        function topic_on(circle) {
            ...
            d3.select("#" + barFreqsID)
                ...
                .style("text-anchor", "middle")
                .style("font-size", "12px")
                .text("Top-" + R + " Terms for Topic " + topics + " (" + Freq + "% )");
